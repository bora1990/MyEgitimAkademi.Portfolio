...
namespace MyEgitimAkademi.Portfolio.Controllers
{
    ...
    {
        MyPortfolioDbEntities1 db =new MyPortfolioDbEntities1();//bu sınıfın öğelerini kullanabilmek için yazdık.
        ...
        public ActionResult UpdateService(int id)  //id routetan geliyor.
        {
            var value = db.Service.Find(id);
            return View(value);
        }
